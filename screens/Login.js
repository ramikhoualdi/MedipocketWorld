...
const Login = ({ navigation }) => {
  ...
  const [email, onChangeEmail] = useState("ramykhweldi@gmail.com"); // ramykhweldi@gmail.com //kunalkdas@outlook.com //samryker@gmailcom
  const [password, onChangepassword] = useState("hello156"); // hello156 //Kepler@2209
