...
const Login = ({ navigation }) => {
  ...
  const [email, onChangeEmail] = useState("info@thebollywoodbites.com"); // ramykhweldi@gmail.com //kunalkdas@outlook.com //samryker@gmailcom //priyanka@mymedipocket.com //info@thebollywoodbites.com
  const [password, onChangepassword] = useState("Cheena$1"); // hello156 //Kepler@2209 //Cheena$11 //Cheena$1
